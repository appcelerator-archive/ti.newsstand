...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.newsstand.js')
	...
	f = os.path.join(cwd,'Classes','TiNewsstandModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.newsstand.js']
